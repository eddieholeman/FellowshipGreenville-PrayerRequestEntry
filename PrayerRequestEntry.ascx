            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <% if ( EnablePublicDisplayFlag )
                        { %>
                        <Rock:RockCheckBox ID="cbAllowPublicDisplay" runat="server" Checked="false" Label="Check 'Yes' to give permission to include this request in the Prayer & Outreach Newsletter." Text="Yes" />
                    <% } %>
                </fieldset>
